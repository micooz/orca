...
export {
  PATH_TREE_DIRECTORY_PADDING_PX as SOURCE_CONTROL_TREE_DIRECTORY_PADDING_PX,
  PATH_TREE_FILE_PADDING_PX as SOURCE_CONTROL_TREE_FILE_PADDING_PX,
  PATH_TREE_INDENT_PX as SOURCE_CONTROL_TREE_INDENT_PX
